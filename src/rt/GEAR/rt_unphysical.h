...
rt_check_unphysical_mass_fractions(struct part* restrict p) {
  ...
  p->rt_data.tchem.mass_fraction_HI = max(p->rt_data.tchem.mass_fraction_HI, RT_GEAR_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HII = max(p->rt_data.tchem.mass_fraction_HII, RT_GEAR_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeI = max(p->rt_data.tchem.mass_fraction_HeI, RT_GEAR_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeII = max(p->rt_data.tchem.mass_fraction_HeII, RT_GEAR_TINY_MASS_FRACTION);
  p->rt_data.tchem.mass_fraction_HeIII = max(p->rt_data.tchem.mass_fraction_HeIII, RT_GEAR_TINY_MASS_FRACTION);
